...
//   arr.length === 31 ? console.log(true) : console.log(false)
...
function addFlavor(item, originalFlavors) {
  return originalFlavors.unshift(item)
}

addFlavor('Thai Tea', originalFlavors)
console.log('Task 2', originalFlavors)
...
function getFlavorByIndex(originalFlavors, num) {
  console.log('Task 4', originalFlavors[num])
}
...
function removeFlavorByName(originalFlavors, str) {
  return originalFlavors.splice(0, 2, str)
}

removeFlavorByName(originalFlavors, 'Vanilla')
console.log('Task 5', originalFlavors.length)
...
function copy(newArr, originalFlavors) {
  return newArr.push(originalFlavors)
}

copy(newArr, originalFlavors)
console.log('Task 6', newArr)
...
function filterByWord(originalFlavors, item) {
  ...
  for (let i = 0; i < originalFlavors.length; i++) {
    if (originalFlavors[i].includes(item)) {
      filteredItems.push(originalFlavors[i])
    }
  }

  // with filter, but don't use (missed instruction):
  //   originalFlavors.filter(x => {
  //     if (x.includes(item)) {
  //       return filteredItems.push(x)
  //     }
  //   })
...
function getRandomFlavors(arr1, arr2, arr3, arr4) {
  const allTheFlavors = [...arr1, ...arr2, ...arr3, ...arr4]
